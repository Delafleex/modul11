    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src="<?php echo e(asset('assets/images/logo-white.svg')); ?>" alt="logo" style="width: 40px">
            </a>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="<?php echo e(asset('assets/images/main.svg')); ?>" alt="main logo">
                </div>
    ...
    <div id="bs-icons">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="<?php echo e(asset('assets/images/bs-icons.png')); ?>" alt="Bootstrap Icons">
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="bs-themes">
        ...
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="<?php echo e(asset('assets/images/bs-themes.png')); ?>" alt="Bootstrap Themes">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img class="img-fluid" src="<?php echo e(asset('assets/images/logo-black.svg')); ?>" alt="Bootstrap Logo" style="width: 40px">
                    ...
                    <div class="mt-2 text-muted">
                        <small>
                            ...
                            of <a href="#" class="text-black">our contributors</a>.
                        </small>
                    </div>
                    <div class="mt-2 text-muted">
                        <small>
                            Code licensed <a href="#" class="text-black">MIT</a>, docs
                            <a href="#" class="text-black">CC BY 3.0</a>.
                        </small>
                    </div>
                    <div class="mt-2 text-muted">
...
<?php /**PATH C:\xampp\htdocs\laravel\your-project-name\resources\views/index.blade.php ENDPATH**/ ?>