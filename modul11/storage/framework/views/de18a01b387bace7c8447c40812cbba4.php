...
<body>
    <div class="container m-5">
        ...
        <div class="list-group list-group-numbered mt-4">
            ...
            <a href="<?php echo e(url('/view_route')); ?>" class="list-group-item list-groupitem-action">
                View Route
            </a>
            <a href="<?php echo e(url('/controller_route')); ?>" class="list-group-item listgroup-item-action">
                Controller Route
            </a>
            ...
            <a href="<?php echo e(route('bootstrap')); ?>" class="list-group-item list-group-itemaction">
                Bootstrap
            </a>
...
<?php /**PATH F:\kuliah\SEMESTER 3\modul11\resources\views/routing.blade.php ENDPATH**/ ?>